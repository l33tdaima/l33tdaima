...
var validPalindromeAtMostK = function(s, k) {
    let isPalindrome = function(l, r, d) {
        ...
        if (s[l] === s[r]) {
            ...
            return d > 0 && (isPalindrome(l+1, r, d-1) || isPalindrome(l, r, d-1));
        }
    }
...
[
    ...
    console.log("Can we make", t, "a palindrome with at most 1 tremoval? ->",
                validPalindrome(t), validPalindromeAtMostK(t, 1));
    console.log("Can we make", t, "a palindrome with at most 2 tremoval? ->",
